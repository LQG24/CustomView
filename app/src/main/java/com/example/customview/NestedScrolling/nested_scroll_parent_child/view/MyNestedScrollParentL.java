package com.example.customview.NestedScrolling.nested_scroll_parent_child.view;
...
//        Log.i("onMeasure","show: " + show + ", hide: " + hide);
        if (show || hide) {//1.作业 消费过头
            ...
            int scrollY = view.getHeight() - getScrollY();//还有多少到顶

//            Log.i("lqg","height: " + view.getHeight()  + ", getScrollY: " + getScrollY());
