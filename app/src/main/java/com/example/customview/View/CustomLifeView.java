...
/**
 * 自定义View来观察View与Activity生命周期的变化
 */
public class CustomLifeView extends View {

    private static final String TAG = "lqg->View";

    public CustomLifeView(Context context) {
        super(context);
        Log.d(TAG, "CustomLifeView()");
    }

    public CustomLifeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG, "CustomLifeView()");
    }

    public CustomLifeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
